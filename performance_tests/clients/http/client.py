...
from performance_tests.clients.http.event_hooks.locust_event_hook import locust_request_event_hook, \
...
def build_gateway_locust_http_client(environment: Environment) -> Client:
    ...
    # Это избавляет консоль от лишнего вывода при высоко-нагруженных тестах
