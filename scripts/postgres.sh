...
psql -h postgres -U root -f /docker-entrypoint-initdb.d/init-brands.sql
...
psql -h postgres -U root -d brands_service_db -f /docker-entrypoint-initdb.d/grant-brands.sql
